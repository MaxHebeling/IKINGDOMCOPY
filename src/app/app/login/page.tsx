...
export default function LoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        router.push("/app/companies/ikingdom/leads");
      } else {
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: 24 }}>
          <label style={{ display: "block", fontSize: 10, letterSpacing: "0.25em", color: "rgba(212,175,55,0.5)", textTransform: "uppercase", marginBottom: 8 }}>
            Contraseña
          </label>
          <input
            type="password"
