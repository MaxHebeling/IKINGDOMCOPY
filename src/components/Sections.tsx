        ...
        <div className="relative z-10 max-w-[1280px] mx-auto">
          ...
          <Reveal delay={0.35}>
            <div className="text-center">
              <a href={`/${lang}/fit`} data-hover onClick={() => trackCTAClick("whatwedo")} className="group relative inline-flex items-center gap-3 px-8 py-[13px] text-[12px] font-semibold tracking-[0.18em] uppercase text-ink border border-ink/25 overflow-hidden transition-all duration-500 hover:text-bg hover:border-ink">
                <div className="absolute inset-0 bg-ink origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]" />
                <span className="relative z-10 transition-colors duration-500">{t("hero.cta")} →</span>
              </a>
            </div>
          </Reveal>
...
const GALAXY_NODE_DEFS = [
  { n: "01", weekKey: "proc.step.1.week", titleKey: "proc.step.1.title", descKey: "proc.step.1.desc", r: 72,  angle: 325 },
  { n: "02", weekKey: "proc.step.2.week", titleKey: "proc.step.2.title", descKey: "proc.step.2.desc", r: 140, angle: 58  },
  { n: "03", weekKey: "proc.step.3.week", titleKey: "proc.step.3.title", descKey: "proc.step.3.desc", r: 200, angle: 212 },
  { n: "04", weekKey: "proc.step.4.week", titleKey: "proc.step.4.title", descKey: "proc.step.4.desc", r: 252, angle: 128 },
];
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto">
          ...
          <Reveal delay={0.35}>
            <div className="mt-14 flex flex-col sm:flex-row items-start sm:items-center gap-6">
              <CTA href={`/${lang}/fit`} onClick={() => trackCTAClick("engagement")}>{t("hero.cta")}</CTA>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2.2fr_1fr_1.2fr_1.2fr] gap-12 pb-16 border-b border-divider">
            ...
            <div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-[9px] tracking-[0.34em] uppercase" style={{ color: "rgba(212,175,55,0.55)" }}>{t("footer.status")}</span>
              </div>
            </div>

            {/* ── Col 2 · Navegación ── */}
            <div>
              <p className="text-[9px] tracking-[0.38em] uppercase mb-7" style={{ color: "rgba(212,175,55,0.55)" }}>{t("footer.nav.label")}</p>
            ...
            {/* ── Col 3 · Servicios ── */}
            <div>
              <p className="text-[9px] tracking-[0.38em] uppercase mb-7" style={{ color: "rgba(212,175,55,0.55)" }}>{t("footer.services.label")}</p>
              <ul className="space-y-3.5">
